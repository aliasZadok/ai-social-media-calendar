...
const getIcon = (platform: string): JSX.Element | null => {
  const normalizedPlatform = capitalizeFirstLetter(platform) as SocialMediaPlatform;
  return socialMediaIcons[normalizedPlatform] || null;
}
        ...
        <DialogContent className="bg-background">
          <DialogHeader>
            <DialogTitle className="flex items-center space-x-2">
              ...
              <span>{selectedContent ? capitalizeFirstLetter(selectedContent.platform) : 'Unknown'} Post</span>
            </DialogTitle>
          </DialogHeader>
